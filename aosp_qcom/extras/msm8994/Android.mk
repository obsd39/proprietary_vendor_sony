...
LOCAL_SRC_FILES         := etc/perf-profile0.conf
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/
LOCAL_SRC_FILES         := etc/perf-profile1.conf
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/
LOCAL_SRC_FILES         := etc/perf-profile2.conf
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/
LOCAL_SRC_FILES         := etc/perf-profile3.conf
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/
LOCAL_SRC_FILES         := etc/perf-profile4.conf
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_VENDOR_ETC)/
LOCAL_SRC_FILES         := etc/perf-profile5.conf
include $(BUILD_PREBUILT)
